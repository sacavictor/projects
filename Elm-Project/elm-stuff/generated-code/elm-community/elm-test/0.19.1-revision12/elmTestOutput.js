...
var $author$project$Model$PostIds$advance = function (_v0) {
	var id = _v0.a;
	var _v1 = $author$project$Cursor$forward(id);
	if (_v1.$ === 'Just') {
		var cursor = _v1.a;
		return $elm$core$Maybe$Just(
			_Utils_Tuple2(
...
var $author$project$Cursor$fromList = function (xs) {
	if (!xs.b) {
		...
		var rest = xs.b;
		return $elm$core$Maybe$Just(
			A2($author$project$Cursor$nonEmpty, x, rest));
	}
};
...
var $author$project$Model$PostIds$decode = A2(
	...
	function (id) {
		return $elm$json$Json$Decode$succeed(
			$author$project$Model$PostIds$fromList(id));
	},
...
var $author$project$Util$Time$durationBetween = F2(
	function (t1, t2) {
		...
		var days = (hours / 24) | 0;
		return (diffMillis < 0) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
			{
				days: days,
				hours: A2($elm$core$Basics$modBy, hours, 24),
...
var $author$project$Util$Time$formatDuration = function (duration) {
	var formatUnit = F2(
		function (value, unit) {
			return (value === 1) ? ($elm$core$String$fromInt(value) + (' ' + (unit + ' ago'))) : ($elm$core$String$fromInt(value) + (' ' + (unit + 's ago')));
		});
	...
	var nonZeroComponents = A2(
		$elm$core$List$map,
		function (_v2) {
			var value = _v2.a;
			var unit = _v2.b;
			return A2(formatUnit, value, unit);
		},
		A2(
			...
			components));
	if (!nonZeroComponents.b) {
		return 'just now';
	} else {
		var first = nonZeroComponents.a;
		var rest = nonZeroComponents.b;
		return A2(
			$elm$core$String$join,
			' ',
			A2(
...
var $author$project$Util$Time$posixToDate = F2(
	function (tz, time) {
		return $author$project$Util$Time$Date(
			{
				day: A2($elm$time$Time$toDay, tz, time),
				month: A2($elm$time$Time$toMonth, tz, time),
				year: A2($elm$time$Time$toYear, tz, time)
			});
	});
...
var $author$project$View$Posts$postTable = F3(
	function (_v0, currentTime, posts) {
		return A2(
			$elm$html$Html$table,
			_List_fromArray(
				[
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['C:\\Users\\User\\Documents\\pf\\Elm-Project\\tests\\ExampleTests\\CursorTests.elm', 'C:\\Users\\User\\Documents\\pf\\Elm-Project\\tests\\ExampleTests\\ModelPostIdsTests.elm', 'C:\\Users\\User\\Documents\\pf\\Elm-Project\\tests\\ExampleTests\\ModelPostsConfigTests.elm', 'C:\\Users\\User\\Documents\\pf\\Elm-Project\\tests\\ExampleTests\\UtilTimeTests.elm', 'C:\\Users\\User\\Documents\\pf\\Elm-Project\\tests\\MainTests.elm', 'C:\\Users\\User\\Documents\\pf\\Elm-Project\\tests\\PostsConfigTests.elm', 'C:\\Users\\User\\Documents\\pf\\Elm-Project\\tests\\PostsViewTests.elm', 'C:\\Users\\User\\Documents\\pf\\Elm-Project\\tests\\PostTests.elm', 'C:\\Users\\User\\Documents\\pf\\Elm-Project\\tests\\SimulatedEffect.elm', 'C:\\Users\\User\\Documents\\pf\\Elm-Project\\tests\\TestData.elm', 'C:\\Users\\User\\Documents\\pf\\Elm-Project\\tests\\TestUtils.elm']),
		processes: 4,
...
var pipeFilename = "\\\\.\\pipe\\elm_test-7480-1";
var net = require('net'),
